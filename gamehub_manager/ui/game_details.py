...
class GameDetailsPanel(QWidget):
    ...
    def set_game(self, game: dict[str, Any]) -> None:
        ...
        self.cover_label.setText(game.get("cover_image_path") or PLACEHOLDER_COVER_TEXT)
        ...
        self.install_status_value.setText(str(game.get("install_status") or "Not installed"))
        ...
        launch_target = game.get("executable_path") or game.get("rom_path") or ""
